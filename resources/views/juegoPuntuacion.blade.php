    ...
    <main class="d-flex flex-column  align-items-center">
        <div class="primer">
           <!-- Background image -->
                ...
                <!-- CARD -->
                <div class="user_card-puntuacion p-5">
                    <div class="text-center h-100 titulo-puntos">
                        <h4>Ha obtenido la siguiente puntuación:</h4>
                    </div>
                    <div class="d-flex justify-content-center align-items-center">
                        <!-- IMAGEN -->
                        <div class="puntos">
                            @foreach ($usuarios as $usuario)
                                @if ($usuario->nickname == session('usuario'))
                                    <div class="img">
                                    ...
                                    <div>{{$usuario->nickname}}</div>
                                    <div class="ptos">
                                        {{$usuario->puntos}}
                                        puntos
                                    </div>
                                    <div class="fechaHora">
                                        <div>{{$usuario->fecha}}</div>
                                        <div>{{$usuario->hora}}</div>
                                    </div>
                                @endif
                            @endforeach
                        </div>
